...
![**Overall workflow in computational biology.** The yellow boxes indicate parts that are useful to keep under version control, e.g. Git. The manuscript is common to keep under a different kind of source control, i.e. the "tracked changes" functionality in word processors.](img/computational_workflow.png)
