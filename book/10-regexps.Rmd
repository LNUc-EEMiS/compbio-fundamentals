...
Note that the last alternative does not work as intended with MacOS sed and must be modified:
...
explicitly specify "no extention" by setting it to (`""`), otherwise an error is thrown:
