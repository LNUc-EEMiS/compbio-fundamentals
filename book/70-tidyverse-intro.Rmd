...
In addition, a must-read is: [Data Visualization A Practical Introduction](https://socviz.co/index.html#preface) by Kieran Healy from the Duke University.
...
- Write scripts for heavy analyses that need not be rerun; work with figures and tables in RMarkdown documents (see \@ref(rmarkdown)).
