...
before one can start identifying one's own sequences. This training is very important, since having
an index built from incorrect sequences, i.e. not the target sequence, or another part of the
