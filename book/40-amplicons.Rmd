...
sequencing run. They were able to resolve this problem as they routinely added a sample of a mock
...
of this definition, all sequences need to be compared with each other, which is time consuming if you
...
although at a later stage, this choice might prove sub optimal. See also the [Wikipedia
...
During the PCR reaction, artifactual products formed from two different molecules -- *chimeras* or,
...
i.e. parents are not required to be more abundant is, in my experience too harsh; I have good
...
related species have quite similar 8mer frequencies. This can be used to identify sequences. In
